"""
Django settings for file_sharing_backend project.
...
SECRET_KEY = '_9k@q!%qm$^0w%pd-4u+#19ud*4aurcivxwsl6s$juz-nf^edy'
...
ROOT_URLCONF = 'file_sharing_backend.urls'
...
WSGI_APPLICATION = 'file_sharing_backend.wsgi.application'
